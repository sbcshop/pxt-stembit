...
namespace StemBit_Display {
    ...
    //% blockId=stembit_LED1 block="LED light at pin %pin| status %value"
    //% weight=5
    //% blockGap=8
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=1
    export function LED1(pin: DigitalPin, value: Status): void {
        pins.digitalWritePin(pin, value);
    }

    //% blockId=stembit_LED2 block="LED at pin %pin| with brightness %value"
    //% weight=4
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_BreathLED block="Breath LED at pin %pin"
    //% weight=3
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_RGB block="RGB color LED at pin R %pin1| and PIN G %pin2|PIN B %pin3| Red %value1| Green %value2| Blue %value3"
    //% weight=2
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_RGB2 block="RGB Color light at Pin R %pin1| Pin G %pin2| and Pin B %pin3| display %value"
    //% weight=1
    //% blockGap=8
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    export function RGB2(pin1: DigitalPin, pin2: DigitalPin, pin3: DigitalPin, value: Colours): void {
...
namespace StemBit_Sensor {
    ...
    //% blockId=stembit_Voice_Sensor block="Sound sensor at Pin %pin|set %value"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=stembit_IR_Sensor block="Infrared Sensor at Pin %pin| set %value| obstacle"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=stembit_IR_Send block="Infrared Emission at Pin %pin"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=stembit_ultrasonic block="Ultrasonic at Trigger Pin %Trig| Reveive at %Echo"
    //% color="#87CEEB"
    //% weight=100
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
...
namespace StemBit_Input {
    ...
    //% blockId=stembit_TouchPad block="Touch switch at Pin %pin| set %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    ...
    //% blockId=mbit_Rocker block="Rocker |VRX %pin1|VRY %pin2|SW %pin3|set %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    ...
    //% blockId=stembit_Button block="Button at Pin %pin|set %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
...
namespace StemBit_Music {
    ...
    //% blockId=stembit_Buzzer block="Active Buzzer at Pin %pin| value %value"
    //% weight=100
    //% blockGap=10 
    //% color="#D2691E"
...
namespace StemBit_Motor {
    ...
    //% blockId=stembit_Fan block="Fan at Pin %pin| speed %value"
    //% weight=100
    //% blockGap=10
    //% color="#0000CD"
    ...
    //% blockId=stembit_Servo block="Servo Pin %pin| angle %value"
    //% weight=100
    //% blockGap=10
    //% color="#0000CD"
...
namespace StemBit_Car {
     ...
     * @param index
     */
    //% blockId=stembit_RGB_Car_Big2 block="Car RGB Light colour %value"
    //% weight=101
    //% blockGap=10
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    export function RGB_Car_Big2(value: Colours): void {
    ...
    //% blockId=stembit_RGB_Car_Big block="Car RGB Light Red %value1| Green %value2|Blue %value3"
    //% weight=100
    //% blockGap=10
    //% color="#C814B8"
    //% value1.min=0 value1.max=255 value2.min=0 value2.max=255 value3.min=0 value3.max=255
    ...
    //% blockId=stembit_RGB_Car_Program block="Colourful Water Light"
    //% weight=99
    //% blockGap=10
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
	...
	//% blockId=stembit_ultrasonic_car block="Ultrasonic, distance in cms"
    //% color="#006400"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=stembit_Music_Car block="Car Play Music |%index"
    //% weight=97
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=stembit_Avoid_Sensor block="Obstacle avoidance sensor detect %value"
    //% weight=95
    //% blockGap=10
    //% color="#006400"
